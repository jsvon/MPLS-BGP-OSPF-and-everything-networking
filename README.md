...
R1#sh running-config interface gigabitEthernet 1/0
...
R1#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R2#sh running-config interface gigabitEthernet 1/0
Building configuration...
...
R2#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R2#sh running-config interface gigabitEthernet 3/0
Building configuration...
...
R2#sh running-config interface gigabitEthernet 4/0
Building configuration...
...
R3#sh running-config interface gigabitEthernet 1/0
Building configuration...
...
R3#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R3#sh running-config interface gigabitEthernet 3/0
Building configuration...
...
R3#sh running-config interface gigabitEthernet 4/0
Building configuration...
...
R4#sh running-config interface gigabitEthernet 1/0
Building configuration...
...
R4#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R5#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R5#sh running-config interface gigabitEthernet 4/0
Building configuration...
...
R6#sh running-config interface gigabitEthernet 2/0
Building configuration...
...
R6#sh running-config interface gigabitEthernet 3/0
Building configuration...
...
R7#sh running-config interface gigabitEthernet 1/0
Building configuration...
...
R7#sh running-config interface gigabitEthernet 3/0
Building configuration...
...
R8#sh running-config interface gigabitEthernet 1/0
Building configuration...
...
R8#sh running-config interface gigabitEthernet 4/0
Building configuration...
